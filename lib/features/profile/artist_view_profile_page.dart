...
class _ArtistViewProfilePageState extends ConsumerState<ArtistViewProfilePage>
  ...
  Map<String, dynamic> get _artistData {
    ...
    if (gearshArtist != null) {
      return {
        ...
        'headerImage': gearshArtist.coverImage ?? gearshArtist.image,
        'coverImage': gearshArtist.coverImage,
    ...
    // No artist found - return default
    return _getDefaultArtist();
  }
  ...
  Map<String, dynamic> _getDefaultArtist() {
    return {
      ...
      'isVerified': false,
      'isAvailable': false,
      'bio': 'This artist profile could not be found.',
      'highlights': [],
      'equipment': [],
      'services': [],
      'discography': [],
  ...
  // Build cover gradient based on category
  Widget _buildCoverGradient(String? category) {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Positioned.fill(
            child: CustomPaint(
              painter: _CoverPatternPainter(color: Colors.white.withAlpha(13)),
            ),
          ),
        ],
      ),
                      ...
                      children: [
                        ...
                        data['coverImage'] != null
                            ? Image.asset(
                                data['coverImage'],
                                fit: BoxFit.cover,
                                errorBuilder: (_, __, ___) => _buildCoverGradient(data['category']),
                              )
                            : _buildCoverGradient(data['category']),
                        // Gradient overlay
                        Container(
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
