...
class _LandingPageState extends State<LandingPage> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                _buildArtistCard('Y.D.E', 'Hip Hop', 'assets/images/artists/yde.png', 'yde', cardWidth),
                _buildArtistCard('ZJ90', 'DJ', 'assets/images/artists/ZJ90.jpg', 'zj90', cardWidth),
                _buildArtistCard('Rix Elton', 'Amapiano', 'assets/images/artists/rixelton.jpg', 'rix-elton', cardWidth),
              ],
            ),
          ),
          const SizedBox(height: 20),
  ...
  static const List<Map<String, dynamic>> _pastBookings = [
    ...
    {
      'id': 'b4',
      'artistId': 'empress-ngqama',
      'artistName': 'Empress Ngqama',
      'artistImage': 'assets/images/artists/empress-ngqama.jpg',
  ...
  static const List<Map<String, dynamic>> _payments = [
    {
      'id': 'p1',
      'description': 'Y.D.E - Live Performance',
      'date': 'Dec 15, 2025',
      'amount': 3000,
      'status': 'pending',
    },
    {
      'id': 'p2',
      'description': 'Rix Elton - Club Night',
      'date': 'Oct 15, 2025',
      'amount': 2000,
      'status': 'paid',
    },
    {
      'id': 'p3',
      'description': 'Empress Ngqama - Private Event',
      'date': 'Sep 28, 2025',
      'amount': 4500,
      'status': 'paid',
    },
