  ...
  var GLOG_POSTS = [
    {
      ...
      content: [
        ...
        '',
        'On Gearsh, artists like Tyla appear as discoverable, bookable profiles — because when the call comes, you need a link ready, not a DM thread.',
        '',
    ...
    },
    {
      ...
      content: [
        ...
        '| --- | --- | --- |',
        '| Headline | Kabza De Small, DJ Maphorisa | R250k – R500k+ |',
        '| Established | Major League DJz, Felo Le Tee | R80k – R180k |',
        '| Rising | Breakout producers with streaming heat | R25k – R60k |',
        '',
    ...
    },
    {
      ...
      content: [
        ...
        '## What clients book',
        '',
        '- **30-minute praise set** — conferences and corporate openings',
        '- **Full worship experience** — church events and crusades',
        '- **Festival slot** — gospel stages at multi-genre events',
        '',
        '## Pricing reality',
        '',
    ...
    },
    {
      ...
      content: [
        'Your music opens the door. Your **booking profile** closes the deal. Here\'s how South African artists turn Gearsh views into real gigs.',
        '',
        '## 1. Use a solo press photo',
        '',
        'Bookers scroll fast. A clear headshot beats a crowd shot every time.',
        '',
        '## 2. Publish real fees',
        '',
        'Ranges are fine — silence is not. Verified rates build trust with corporate and festival clients.',
        '',
        '## 3. Offer three services',
        '',
        'Club set · festival headline · private event. Match what bookers actually search for.',
        '',
        '## 4. Fill your bio with credentials',
        '',
        'Awards, streaming numbers, cities played — proof reduces negotiation friction.',
        '',
        '## 5. Respond within 24 hours',
        '',
        'The fastest artist to quote often wins the gig, even if they\'re not the cheapest.',
        '',
        '**Ready?** [List your gig on Gearsh](/join-gig.html) — it\'s free to start.',
      ].join('\n'),
    },
  ];
