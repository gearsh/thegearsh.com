...
(function (global) {
  ...
  var GLOG_POSTS = [
    ...
    },
    {
      ...
      featuredImage: 'assets/images/artists/maphorisa.png',
      author: 'Gearsh',
      ...
      content: [
        ...
        '| --- | --- | --- |',
        '| Headline | DJ Maphorisa | R250k to R500k+ |',
    ...
    },
    {
      ...
      tags: ['Shimza', 'Deep House', 'Afro House'],
      content: [
        ...
        '## Artists to watch',
        '',
        'From **Shimza**\'s Afro-tech crossovers to a deep bench of township selectors, SA house artists are among the most toured on the continent.',
        '',
        '## For bookers',
        '',
