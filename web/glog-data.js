...
(function (global) {
  ...
  var GLOG_POSTS = [
    {
      slug: 'samas-return-to-sun-city-2026',
      title: 'The SAMAs Are Back at Sun City: What Music\u2019s Biggest Night Means for SA Artists',
      excerpt: 'South Africa\u2019s biggest music awards return to the iconic Sun City Superbowl. Here\u2019s what the SAMAs mean for artists, bookers, and the business of getting booked in 2026.',
      featuredImage: 'assets/images/artists/empress-ngqama.jpg',
      author: 'Gearsh',
      publishedAt: '2026-06-02',
      readTimeMinutes: 6,
      featured: true,
      categories: ['News', 'Industry Tips', 'Artist Spotlight'],
      tags: ['SAMAs', 'Sun City', 'Awards season', 'South African music'],
      content: [
        'The **South African Music Awards** are heading back to where the legend was built: the **Sun City Superbowl**. For decades, this stretch of the North West has been the spiritual home of Mzansi\u2019s biggest music night \u2014 red carpets, live orchestras, surprise reunions, and the trophies that turn local heroes into household names.',
        '',
        'The return to Sun City isn\u2019t just nostalgia. It\u2019s a statement: the SAMAs are a destination event again, and the whole industry is about to orbit one resort for a weekend.',
        '',
        '## Why Sun City matters',
        '',
        'Sun City is more than a venue. It\u2019s a self-contained entertainment city \u2014 hotels, the Superbowl arena, the Valley of Waves \u2014 built for spectacle. When the SAMAs land there, it pulls in artists, labels, media, brands, and fans from every province at once.',
        '',
        'That concentration is exactly why the weekend matters to working artists. Awards season is **booking season**.',
        '',
        '> Awards nights crown a handful of winners. But the real money moves in the bookings that follow \u2014 the after-parties, brand activations, and corporate shows that chase the buzz.',
        '',
        '## The ripple effect for artists',
        '',
        'A nomination, a performance slot, or even a viral red-carpet moment changes an artist\u2019s booking value overnight. In the weeks around the SAMAs, expect a surge in demand for:',
        '',
        '- **Headline and support sets** at official and unofficial after-parties',
        '- **Brand activations** wanting nominated and trending artists',
        '- **Corporate and private bookings** riding the season\u2019s momentum',
        '- **Collaborations** as artists meet, link, and plan in one place',
        '',
        'The artists who cash in aren\u2019t always the winners. They\u2019re the ones who are **easy to book** the moment the spotlight hits.',
        '',
        '## Be ready before the red carpet',
        '',
        'If a promoter sees you trending on SAMAs weekend, you have hours \u2014 not days \u2014 to lock the gig. A buried DM thread loses to a clean, bookable profile every time. Before the season peaks, make sure you have:',
        '',
        '1. **A sharp solo press photo** \u2014 the first thing a booker sees.',
        '2. **Clear, verified fees** \u2014 a starting number so clients can budget instantly.',
        '3. **Defined service tiers** \u2014 club set, festival headline, private event.',
        '4. **Fast response times** \u2014 the quickest quote often wins the booking.',
        '',
        'That\u2019s the entire idea behind Gearsh: turn the attention into income without an agency standing between you and the cheque.',
        '',
        '## For the fans heading to the North West',
        '',
        'SAMAs weekend means the surrounding scene lights up too \u2014 club nights, pop-ups, and shows across Sun City, Rustenburg, and back into Joburg. Use the [Gig Guide](/gigs) to find what\u2019s on and grab tickets in seconds.',
        '',
        '## The bottom line',
        '',
        'The SAMAs returning to Sun City is a win for South African music \u2014 a reminder that our biggest night deserves its biggest stage. For artists, it\u2019s a deadline: the industry is about to look your way. Make sure that when it does, you\u2019re one click away from being booked.',
        '',
        '**Get your profile ready for the season.** [List your gig on Gearsh](/join-gig.html) \u2014 it\u2019s free to start, and you go live in minutes.',
      ].join('\n'),
    },
    {
      ...
      featuredImage: 'assets/images/artists/rixelton.jpg',
      author: 'Gearsh',
      publishedAt: '2026-05-18',
      readTimeMinutes: 6,
      categories: ['Amapiano', 'Industry Tips', 'News'],
      tags: ['Amapiano', 'Booking fees', 'Festivals'],
      content: [
        ...
        '| --- | --- | --- |',
        '| Headline | Chart-topping national headliners | R250k to R500k+ |',
        '| Established | Touring DJs with festival slots | R80k to R180k |',
    ...
    },
    {
      ...
      featuredImage: 'assets/images/artists/ZJ90.jpg',
      author: 'Gearsh',
      publishedAt: '2026-05-12',
      readTimeMinutes: 4,
      categories: ['Afro House', 'News'],
      tags: ['Deep House', 'Afro House'],
      content: [
        ...
        '## Artists to watch',
        '',
        'From Afro-tech crossovers to a deep bench of township selectors, SA house artists are among the most toured on the continent. On Gearsh, DJs like **ZJ90** bring that same midweek energy to bookable club sets.',
        '',
        '## For bookers',
        '',
    ...
    },
    {
      ...
      featuredImage: 'assets/images/artists/yde.png',
      author: 'Gearsh',
