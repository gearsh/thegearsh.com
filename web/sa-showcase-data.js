...
const SA_SHOWCASE_ARTISTS = [
  ...
  },
  {
    ...
    image: 'assets/images/artists/artists.png',
    category: 'DJ',
    genre: 'Amapiano · Afro House · Johannesburg',
    genreSlug: 'amapiano',
    location: 'Johannesburg',
    country: 'South Africa',
    masteryHours: 3200,
    ...
    badgeClass: 'fb-new',
    hourlyRate: 7000,
    bio: 'DJ Buhle (@DJ_Buhle) — invited to Gearsh with an 80% intro discount (early-booking rate from R35,000 down to R7,000). Claim this profile to manage bookings and payments, or request removal if you prefer not to be listed.',
    skills: ['Amapiano', 'Afro House', 'DJ', 'Live Performance'],
  },
  {
    name: 'Empress Ngqama',
